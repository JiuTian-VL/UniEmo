...
data_root = f"/hy-tmp/zyj/EmoGen/data/arranged_EmoSet-118K/{property}"
image_paths = []
for root, _, file_path in tqdm(os.walk(data_root)):
    for file in file_path:
        if file.endswith("jpg"):
            ...
            annotion_path = f'/hy-tmp/zyj/EmoGen/data/arranged_EmoSet-118K/annotation/{emotion}/{emotion}_{number}.json'
...
with open(f'/hy-tmp/zyj/EmoGen/dataset_balance/{property}_norepeat.pkl', 'wb') as f:
